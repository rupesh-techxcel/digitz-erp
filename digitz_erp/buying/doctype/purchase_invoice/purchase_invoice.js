...
let general_ledgers = function (frm) {
    frappe.call({
        method: "digitz_erp.buying.doctype.purchase_invoice.purchase_invoice.get_gl_postings",
        args: {
            purchase_invoice: frm.doc.name
        },
        callback: function (response) {
...
let stock_ledgers = function (frm) {
    frappe.call({
        method: "digitz_erp.buying.doctype.purchase_invoice.purchase_invoice.get_stock_ledgers",
        args: {
            purchase_invoice: frm.doc.name
        },
        callback: function (response) {
