...
let general_ledgers = function (frm) {
    frappe.call({
        method: "digitz_erp.selling.doctype.sales_return.sales_return.get_gl_postings",
        args: {
            sales_return: frm.doc.name
        },
        callback: function (response) {
...
let stock_ledgers = function (frm) {
    frappe.call({
        method: "digitz_erp.selling.doctype.sales_return.sales_return.get_stock_ledgers",
        args: {
            sales_return: frm.doc.name
        },
        callback: function (response) {
