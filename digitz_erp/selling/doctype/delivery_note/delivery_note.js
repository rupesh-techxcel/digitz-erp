...
let general_ledgers = function (frm) {
    frappe.call({
        method: "digitz_erp.selling.doctype.delivery_note.delivery_note.get_gl_postings",
        args: {
            delivery_note: frm.doc.name
        },
        callback: function (response) {
...
let stock_ledgers = function (frm) {
    frappe.call({
        method: "digitz_erp.selling.doctype.delivery_note.delivery_note.get_stock_ledgers",
        args: {
            delivery_note: frm.doc.name
        },
        callback: function (response) {
