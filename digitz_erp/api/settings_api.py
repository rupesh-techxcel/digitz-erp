...
def get_company_settings():
    default_company = get_default_company()
    company_settings = frappe.db.sql("""select default_currency, use_customer_last_price, use_supplier_last_price,tax_excluded,default_asset_location,use_custom_item_group_description_in_estimation from tabCompany where name='{0}'""".format(default_company), as_dict = True)        
